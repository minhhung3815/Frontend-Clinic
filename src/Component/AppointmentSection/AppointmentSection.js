      ...
      <div className="container mx-auto py-12 md:flex items-center">
        ...
        <div>
          ...
          <p className="text-xl px-5 md:px-0 md:w-3/5 mx-auto text-jusify text-white py-6">
            ...
            health. We have put protocols to protect our patients and staff
            while continuing to provide medically necessary care.
          </p>
          <div className="text-center">
            <button
              className="px-4 text-xl py-2 border border-white text-white"
              onClick={() => {
                navigate("/doctors");
              }}
            >
